...
mj_model = MJ.MjModel.from_xml_path("../models/world_6_general.xml")
...
class arm7(opspace):
    def __init__(self, model, data, K, K0, KI):
        ...
        self.offset = 0.15
        self.mocap_id = model.body("L_mocap_marker").mocapid[0]
...
class arm6(arm7):
    def __init__(self, model, data, K, K0, KI):
        ...
        self.offset = 0.06
        self.mocap_id = model.body("R_mocap_marker").mocapid[0]
